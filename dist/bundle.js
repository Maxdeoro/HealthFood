...
function getStaticInformation(selector, activeClass) {
    ...
    elements.forEach((elem) => {
        elem.addEventListener('click', (e) => {
            if (e.target.getAttribute('data-ratio')) {          //если e.target имеет атрибут data-ratio...
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (tabs);      //экспорт ф-ции tabs
